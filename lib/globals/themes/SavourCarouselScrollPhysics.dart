...
class SavourCarouselScrollPhysics extends ScrollPhysics {
  final double itemDimension;

  SavourCarouselScrollPhysics({this.itemDimension, ScrollPhysics parent})
      : super(parent: parent);

  @override
  SavourCarouselScrollPhysics applyTo(ScrollPhysics ancestor) {
    return SavourCarouselScrollPhysics(
